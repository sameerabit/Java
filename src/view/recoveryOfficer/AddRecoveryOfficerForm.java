 ...
 * @author Sameera
 */
public class AddRecoveryOfficerForm extends javax.swing.JDialog {

    /**
     * Creates new form AddRecoveryOfficerForm
     */
    public AddRecoveryOfficerForm(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void submitButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitButtonActionPerformed
        try {
            ...
            RecoveryOfficer recoveryOfficer = new RecoveryOfficer(officerId, name, nic, address, telNo);
            ...
            boolean res = recoveryOfficerControler.addRecoveryOfficer(recoveryOfficer);
            
            if(res == true){
                JOptionPane.showMessageDialog(this, "Recovery Officer successfully added.");
                boolean rep = userController.addNewUser(user);
                if(rep == true){
                    JOptionPane.showMessageDialog(this, "Recovery officer added as a user.");
                }else{
                    JOptionPane.showMessageDialog(this, "Failed to add Recovery Officer as a user.");
                }
            }else{
                JOptionPane.showMessageDialog(this, "Failed to add Recovery Officer.");
            }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AddRecoveryOfficerForm dialog = new AddRecoveryOfficerForm(new javax.swing.JFrame(), true);
