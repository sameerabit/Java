 ...
 * @author Hasitha
 */
public class AddLesseeForm extends javax.swing.JFrame {
    ...
    /**
     * Creates new form AddLesseeForm
     */
    public AddLesseeForm() {
        initComponents();
        ...
        try {
            ...
            Logger.getLogger(AddLesseeForm.class.getName()).log(Level.SEVERE, null, ex);
        }
        
        ////////////////
        clientId = "LS000001";
        marketingOfficerId = "MK0001";
        lesseeIdTextField.setText(clientId);
        ...
        try {
            ...
            RecoveryOfficerControler recoveryOfficerControler = serverConnector.getRecoveryOfficerControler();
            System.out.println(" clientController :"+serverConnector.getClientController());
            
            recoveryOfficerId = recoveryOfficerControler.getNextRecoveryOfficerToRecover();
    ...
    private void initComponents() {
        ...
        lessseeIdLabel = new javax.swing.JLabel();
        ...
        setTitle("L B FINANCE");
        setResizable(false);
        getContentPane().setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        recognitionDetailPanel.setBackground(new java.awt.Color(204, 204, 204));
        ...
        recognitionDetailPanel.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        recognitionDetailPanel.setOpaque(false);
        recognitionDetailPanel.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        lessseeIdLabel.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        lessseeIdLabel.setText("Lessee ID :");
        recognitionDetailPanel.add(lessseeIdLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(15, 32, -1, -1));

        lesseeIdTextField.setEditable(false);
        lesseeIdTextField.setBackground(new java.awt.Color(233, 231, 231));
        lesseeIdTextField.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        recognitionDetailPanel.add(lesseeIdTextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 30, 99, 21));
        ...
        recognitionDetailPanel.add(nameTextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 60, 354, 21));
        ...
        recognitionDetailPanel.add(citizenshipTextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 120, 170, 21));
        ...
        nicFormattedTextField.setText("Lessee ID :");
        ...
        recognitionDetailPanel.add(nicFormattedTextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 90, 170, -1));

        jLayeredPane1.add(recognitionDetailPanel);
        recognitionDetailPanel.setBounds(10, 70, 630, 150);
        ...
        contactDeatailPanel.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        ...
        contactDeatailPanel.add(pvtAddressLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(15, 32, -1, -1));
        ...
        contactDeatailPanel.add(privateAddressTextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 30, 354, 21));

        officialAddressLabel.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        officialAddressLabel.setText("Official Address :");
        contactDeatailPanel.add(officialAddressLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(15, 59, -1, -1));
        ...
        contactDeatailPanel.add(officialAddressTextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 60, 354, 21));

        statusPvtLabel.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        statusPvtLabel.setText("Status in Private Address :");
        contactDeatailPanel.add(statusPvtLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(15, 84, -1, -1));

        telNoLabel.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        telNoLabel.setText("Tel. No :");
        contactDeatailPanel.add(telNoLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(15, 110, -1, -1));
        ...
        contactDeatailPanel.add(ownerRadioButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 80, -1, -1));
        ...
        contactDeatailPanel.add(tenantRadioButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 80, -1, -1));
        ...
        contactDeatailPanel.add(boarderRadioButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 80, -1, -1));
        ...
        contactDeatailPanel.add(telNoFormattedTextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 110, 136, -1));

        jLayeredPane1.add(contactDeatailPanel);
        contactDeatailPanel.setBounds(10, 240, 630, 150);
        ...
        otherDetailPanel.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        ...
        otherDetailPanel.add(occupationLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(15, 20, -1, -1));
        ...
        otherDetailPanel.add(occupationTextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(198, 18, 354, 21));

        organizationTypeLabel.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        organizationTypeLabel.setText("Organization Type :");
        otherDetailPanel.add(organizationTypeLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(15, 45, -1, -1));
        ...
        otherDetailPanel.add(soleProprietorshipRadioButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(198, 45, -1, -1));
        ...
        otherDetailPanel.add(partnershipRadioButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(339, 45, -1, -1));
        ...
        otherDetailPanel.add(limitedComanyRadioButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(436, 45, -1, -1));

        residentDurationLabel.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        residentDurationLabel.setText("Resident Duration :");
        otherDetailPanel.add(residentDurationLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(15, 77, -1, -1));

        maritalLabel.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        maritalLabel.setText("Marital Status :");
        otherDetailPanel.add(maritalLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(15, 111, -1, -1));
        ...
        otherDetailPanel.add(marriedRadioButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(198, 107, -1, -1));
        ...
        otherDetailPanel.add(unmarriedRadioButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(267, 107, -1, -1));

        incomeSourceLabel.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        incomeSourceLabel.setText("Income Source :");
        otherDetailPanel.add(incomeSourceLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(15, 136, -1, -1));
        ...
        otherDetailPanel.add(incomeSourceTextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(198, 134, 354, 21));

        monthlyIncomeLabel.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        monthlyIncomeLabel.setText("Totally Monthly Income :");
        otherDetailPanel.add(monthlyIncomeLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(15, 164, -1, -1));
        ...
        otherDetailPanel.add(monthlyIncomeFormattedTextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(198, 161, 120, -1));

        residentDurationYearLabel.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        residentDurationYearLabel.setText("Years :");
        otherDetailPanel.add(residentDurationYearLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(198, 80, -1, -1));

        residentDurationMonthsLabel.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        residentDurationMonthsLabel.setText("Months :");
        otherDetailPanel.add(residentDurationMonthsLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(327, 80, -1, -1));

        residentDurationDaysLabel.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        residentDurationDaysLabel.setText("Days :");
        otherDetailPanel.add(residentDurationDaysLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(468, 80, -1, -1));
        ...
        otherDetailPanel.add(residentDurationYearFormattedTextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(244, 77, 65, -1));
        ...
        otherDetailPanel.add(residentDurationMonthsFormattedTextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(385, 77, 65, -1));
        ...
        otherDetailPanel.add(residentDurationDaysFormattedTextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(512, 77, 66, -1));

        jLayeredPane1.add(otherDetailPanel);
        otherDetailPanel.setBounds(10, 400, 630, 210);
        ...
        submitButton.setBounds(960, 620, 110, 25);

        jSeparator1.setOrientation(javax.swing.SwingConstants.VERTICAL);
        jLayeredPane1.add(jSeparator1);
        jSeparator1.setBounds(660, 60, 10, 590);
        ...
        incomeTaxPanel.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        ...
        incomeTaxPanel.add(yearLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(15, 30, -1, -1));
        ...
        incomeTaxPanel.add(yearComboBox, new org.netbeans.lib.awtextra.AbsoluteConstraints(125, 27, 110, -1));

        taxableIncomeLabel.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        taxableIncomeLabel.setText("Taxable Income :");
        incomeTaxPanel.add(taxableIncomeLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(15, 64, -1, -1));

        taxLabel.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        taxLabel.setText("Tax :");
        incomeTaxPanel.add(taxLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(15, 102, -1, -1));
        ...
        taxTable.setOpaque(false);
        jScrollPane1.setViewportView(taxTable);

        incomeTaxPanel.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(15, 130, 362, 117));
        ...
        incomeTaxPanel.add(taxableIncomeFormattedTextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(125, 61, 110, -1));
        ...
        incomeTaxPanel.add(taxFormattedTextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(125, 95, 110, -1));

        jLayeredPane1.add(incomeTaxPanel);
        incomeTaxPanel.setBounds(680, 70, 390, 260);
        ...
        bankersPanel.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        ...
        bankersPanel.add(bankNameLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(15, 30, -1, -1));

        bankAddressLabel.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        bankAddressLabel.setText("Address :");
        bankersPanel.add(bankAddressLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(15, 64, -1, -1));

        accountNoLabel.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        accountNoLabel.setText("Account No :");
        bankersPanel.add(accountNoLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(15, 98, -1, -1));
        ...
        bankersPanel.add(bankNameTextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(113, 27, 262, -1));
        ...
        bankersPanel.add(addressTextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(113, 61, 262, -1));
        ...
        bankersPanel.add(accNoTextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(114, 95, 167, -1));
        ...
        bankersPanel.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(15, 124, 360, 110));

        jLayeredPane1.add(bankersPanel);
        bankersPanel.setBounds(680, 340, 390, 270);
        jLayeredPane1.add(backgroundLabel);
        backgroundLabel.setBounds(0, 0, 1090, 650);

        getContentPane().add(jLayeredPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1090, 670));
    ...
    private void citizenshipTextFieldKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_citizenshipTextFieldKeyReleased
        ...
        if (!res) {
            ...
            System.out.println(" new Citizenship :"+evt.getKeyCode());
    ...
    private void submitButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitButtonActionPerformed
        String clientId = lesseeIdTextField.getText();
        String name = nameTextField.getText();
        ...
        //get client details
        Client client = new Client(clientId, recoveryOfficerId, marketingOfficerId, name, nic, occupation, privateAddress, officialAddress, telNo, organizationType, residentDuration, statusInPvt, citizenship, age, maritalStatus, incomeSource, monthlyIncome);

        //get taxTable details
        DefaultTableModel taxdtm = (DefaultTableModel) taxTable.getModel();
        ArrayList<ClientIncomeTax> taxList = new ArrayList<ClientIncomeTax>();

        for (int i = 0; i < taxTable.getRowCount(); i++) {
            ClientIncomeTax tax = new ClientIncomeTax();
            tax.setClientId(clientId);
            String yearString = taxdtm.getValueAt(i, 0).toString();
            tax.setYear(Integer.parseInt(yearString));
        ...
        ArrayList<ClientBankers> bankerList = new ArrayList<ClientBankers>();

        for (int i = 0; i < bankTable.getRowCount(); i++) {
            ClientBankers banker = new ClientBankers();
            banker.setClientId(clientId);
        ...
        try {
            ...
            ClientBankersController bankersController = serverConnector.getClientBankersController();
            ClientIncomeTaxController incomeTaxController = serverConnector.getClientIncomeTaxController();

            boolean res1 = clientController.addClient(client);
            if (res1) {
                boolean res2 = incomeTaxController.addIncomeTax(taxList);
                if (res2) {
                    boolean res3 = bankersController.addBankers(bankerList);
                    if (res3) {
                        JOptionPane.showMessageDialog(this, name + "'s (Lessee) details successfully added.", "Message", JOptionPane.PLAIN_MESSAGE);
                    }
                }
            } else {
                JOptionPane.showMessageDialog(this, "Failed to add " + name + "'s (Lessee) details.", "Message", JOptionPane.ERROR_MESSAGE);
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddLesseeForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JLabel lessseeIdLabel;
